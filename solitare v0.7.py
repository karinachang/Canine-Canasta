...
class Card():
    def __init__(self, number, suit, fullImg = None, selectedImg = None, Hidden = True):
        self.number = number
        self.suit = suit
...
def preRender():
    pass
##    img = PhotoImage(file=row1[0].fullImg)
...
img2 = PhotoImage(file=row1[1].fullImg)
r1 = Label(window, width = WIDTH, height = HEIGHT,image = img2)
